...
def home_mi_club():
    ...
    coleccion_button = tk.Button(home, width=22, height=8, text="Colección", bd=15, bg="violet", fg="white", font=("Arial", 18))
    coleccion_button.grid(row=0, column=0, padx=20, pady=40)

    tienda_button = tk.Button(home, width=22, height=8, text="Tienda", bd=15, bg="violet", fg="white", font=("Arial", 18))
    tienda_button.grid(row=0, column=1, padx=20, pady=40)

    historial_button = tk.Button(home, width=22, height=8, text="Historial", bd=15, bg="violet", fg="white", font=("Arial", 18))
    historial_button.grid(row=1, column=0, padx=20, pady=40)

    arenas_button = tk.Button(home, width=22, height=8, text="Arenas", bd=15, bg="violet", fg="white", font=("Arial", 18))
